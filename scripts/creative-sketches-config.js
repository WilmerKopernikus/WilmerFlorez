...
const CREATIVE_SKETCHES = {
  ...
  'interactive-collage': {
    ...
    buttons: '<button id="changeImage" class="change-image-button">Change Image</button><button id="previewToggle" class="preview-button">Turn Off Preview</button><button id="glitchToggle" class="glitch-button">Turn On Glitch</button><button id="noiseToggle" class="noise-button">Turn On Noise</button>',
