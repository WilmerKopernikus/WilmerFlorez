...
const languagesContent = {
  de: {
    ...
    coolAnimations: "INNOVATIVE ANIMATIONEN",
    coolAnimationsMobile: "INNOVATIVE<br>ANIMATIONEN",
    ...
    kaleidoscopeShaderInstructions: "Anleitung: Klicke, um die Farbpalette zu ändern. Ziehe nach links oder rechts, um die Grundform zu ändern.",
    ...
    btnGlitchOff: "Glitch aus",
    btnNoiseOn: "Noise an",
    btnNoiseOff: "Noise aus",
    btnNegativeOn: "Negativ an",
    ...
    faceMeshLoading: "Gesichtsmodell &amp; Kamera werden geladen\u2026",
    faceMeshLoadingCamera: "Bitte erlaube den Kamerazugriff, wenn du dazu aufgefordert wirst.",
  ...
  en: {
    ...
    coolAnimations: "INNOVATIVE ANIMATIONS",
    coolAnimationsMobile: "INNOVATIVE<br>ANIMATIONS",
    ...
    blancecUebersicht: "<strong>Overview</strong><br />BLANCEC S.A.S. is a Colombian testing laboratory specializing in the certification of products for the national defense industry. The laboratory tests equipment and materials to ensure compliance with the technical standards and safety regulations (including NTS and MINDEN standards) required by the Colombian Ministry of Defense.",
    banderasTitle: "BANDERAS NILA LOPEZ",
    ...
    kaleidoscopeShaderInstructions: "Instructions: Click to change the color palette. Swipe left or right to change the base shape.",
    ...
    interactiveCollageInstructions: "Instructions: Click to add new images to the collage. On mobile devices, double tap to add an image and drag it to position it on the canvas. Use the buttons to apply effects and combine them for unique results.",
    interactiveCollageText: "An interactive pixel manipulation project that lets you stamp images onto the canvas. Toggle between images using the Change Image button. Apply visual effects: Glitch creates horizontal distortions, while Noise warps pixels. Control the mouse preview and combine effects for creative results. Each stamp remembers its effects, allowing unlimited artistic layering.",
    btnChangeImage: "Change Image",
    btnPreviewOff: "Turn Off Preview",
    btnPreviewOn: "Turn On Preview",
    btnGlitchOn: "Turn On Glitch",
    btnGlitchOff: "Turn Off Glitch",
    btnNoiseOn: "Turn On Noise",
    btnNoiseOff: "Turn Off Noise",
    btnNegativeOn: "Turn On Negative",
    ...
    faceMeshLoading: "Loading face model &amp; camera\u2026",
    faceMeshLoadingCamera: "Please allow camera access when prompted.",
    ...
    joblabContent6: "The Job Lab events in Guangzhou, Shanghai, and Beijing attracted around 300 visitors. Attendees engaged in lively discussions, asked thoughtful questions, and remained present throughout the day's program. This enthusiastic reception underscored the project's value and set a strong precedent for annual repetition, turning the Job Lab into a potential ongoing tradition.",
    joblabRoleTitle: "MY ROLE",
    joblabRoleIntro: "Web designer & developer – Sole responsibility for:",
    joblabRoleBullet1: "Design and visual layout of the entire website",
    joblabRoleBullet2: "Website development and programming",
    joblabRoleBullet3: "Publishing and managing the web presence",
    joblabRoleBullet4: "Ongoing maintenance and updates as needed",
    joblabRoleBullet5: "Design of promotional posters for the events",
    joblabRoleBullet6: "Design of a large-format exhibition poster",
    joblabRoleBullet7: "Adapting the website for WeChat compatibility",
  ...
  es: {
    ...
    coolAnimations: "ANIMACIONES INNOVATIVAS",
    coolAnimationsMobile: "ANIMACIONES<br>INNOVADORAS",
...
Responsable del contenido según §55 Abs. 2 RStV`,
    ...
    blancecUebersicht: '<strong>Resumen:</strong><br/>BLANCEC S.A.S. es un laboratorio de ensayos colombiano especializado en la certificación de productos para la industria de defensa nacional. El laboratorio prueba equipos y materiales para garantizar el cumplimiento de las normas técnicas y de seguridad (incluidas las normas NTS y ​​MINDEN) exigidas por el Ministerio de Defensa de Colombia.',
    banderasTitle: "BANDERAS NILA LOPEZ",
    ...
    kaleidoscopeShaderInstructions: "Instrucciones: Haz clic para cambiar la paleta de colores. Desliza hacia la izquierda o hacia la derecha para cambiar la forma base.",
    ...
    btnGlitchOn: "Activar Glitch",
    btnGlitchOff: "Desactivar Glitch",
    btnNoiseOn: "Activar ruido",
    btnNoiseOff: "Desactivar ruido",
    btnNegativeOn: "Activar negativo",
    ...
    faceMeshLoading: "Cargando modelo facial &amp; c\u00e1mara\u2026",
    ...
    joblabContent6: 'Los eventos de Job Lab en Cantón, Shanghái y Pekín atrajeron a alrededor de 300 visitantes. Los asistentes participaron en discusiones animadas, hicieron preguntas reflexivas y permanecieron presentes durante todo el programa del día. Esta recepción entusiasta subrayó el valor del proyecto y sentó un fuerte precedente para la repetición anual, convirtiendo a Job Lab en una posible tradición continua.',
    joblabRoleTitle: 'MI ROL',
    joblabRoleIntro: 'Diseñador web y desarrollador – Responsabilidad exclusiva de:',
    joblabRoleBullet1: 'Diseño visual y maquetación del sitio web completo',
    joblabRoleBullet2: 'Desarrollo y programación del sitio web',
    joblabRoleBullet3: 'Publicación y gestión de la presencia web',
    joblabRoleBullet4: 'Mantenimiento continuo y actualizaciones según fuera necesario',
    joblabRoleBullet5: 'Diseño de carteles publicitarios para los eventos',
    joblabRoleBullet6: 'Diseño de un cartel de gran formato para la exposición',
    joblabRoleBullet7: 'Adaptación del sitio web para su uso en WeChat',
