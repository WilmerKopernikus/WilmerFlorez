...
const languagesContent = {
  de: {
    ...
    interactiveCollageInstructions: "Klicke, um neue Bilder zur Collage hinzuzufügen. Auf mobilen Geräten kannst du mit einem Doppeltipp ein Bild hinzufügen und es über die Leinwand ziehen, um es zu positionieren. Verwende die Buttons, um Effekte anzuwenden und sie für einzigartige Ergebnisse zu kombinieren.",
  ...
  en: {
    ...
    interactiveCollageInstructions: "Click to add new images to the collage. On mobile devices, double tap to add an image and drag it to position it on the canvas. Use the buttons to apply effects and combine them for unique results.",
...
Responsable del contenido según §55 Abs. 2 RStV`,
    ...
    interactiveCollageInstructions: "Haz clic para añadir nuevas imágenes al collage. En dispositivos móviles, toca dos veces para añadir una imagen y arrástrala para posicionarla sobre el lienzo. Usa los botones para aplicar efectos y combinarlos para obtener resultados únicos.",
