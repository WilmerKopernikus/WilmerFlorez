...
const languagesContent = {
  de: {
    ...
    interactiveCollageText: "Ein interaktives Pixel-Manipulationsprojekt, mit dem Bilder direkt auf die Canvas gestempelt werden können. Über den Button „Change Image“ lässt sich zwischen vier Bildern wechseln. Verschiedene visuelle Effekte können angewendet werden: „Glitch“ erzeugt horizontale Verzerrungen, während „Noise Displacement“ die Pixel dynamisch verformt. Die Mouse-Preview kann gesteuert und Effekte kombiniert werden, um kreative Resultate zu erzeugen. Jeder Stamp speichert seine eigenen Effekte und ermöglicht unbegrenztes künstlerisches Layering.",    btnChangeImage: "Bild wechseln",
...
Responsable del contenido según §55 Abs. 2 RStV`,
    ...
    interactiveCollageInstructions: "Instrucciones: Haz clic para añadir nuevas imágenes al collage. En dispositivos móviles, toca dos veces para añadir una imagen y arrástrala para posicionarla sobre el lienzo. Usa los botones para aplicar efectos y combinarlos para obtener resultados únicos.",
    interactiveCollageText: "Un proyecto interactivo de manipulación de píxeles que permite estampar imágenes sobre el canvas. Con el botón “Change Image” puedes alternar entre cuatro imágenes diferentes. Aplica efectos visuales: “Glitch” crea distorsiones horizontales, mientras que “Noise Displacement” deforma los píxeles dinámicamente. Controla la vista previa del mouse y combina efectos para obtener resultados creativos. Cada stamp conserva sus propios efectos, permitiendo un layering artístico ilimitado.",    btnChangeImage: "Cambiar imagen",
