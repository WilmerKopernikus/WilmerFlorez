let sketch7c = function (p) {
  ...
  let p5Instance7c = new p5(sketch7c, 'sketch7c');

  // Attach the p5 instance to the container
  let canvasContainer7c = document.getElementById('sketch7c');
  canvasContainer7c.sketchInstance = p5Instance7c;
  
  // Set up an Intersection Observer to manage noLoop/loop
  let observer7c = new IntersectionObserver((entries) => {
    ...
    // Start observing
  observer7c.observe(canvasContainer7c);