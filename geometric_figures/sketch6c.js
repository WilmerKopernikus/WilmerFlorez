let sketch6c = function(p) {
  ...
  let p5Instance6c = new p5(sketch6c, 'sketch6c');
  
  // Attach the p5 instance to the container
  let canvasContainer6c = document.getElementById('sketch6c');
  canvasContainer6c.sketchInstance = p5Instance6c;
  
  // Set up an Intersection Observer to manage noLoop/loop
  let observer6c = new IntersectionObserver((entries) => {
  ...
  // Start observing
  observer6b.observe(canvasContainer6c);