let sketch2c = (p) => {
    ...
    let p5Instance2c = new p5(sketch2c, 'sketch2c');
  
    // Attach the p5 instance to the container
    let canvasContainer2c = document.getElementById('sketch2c');
    canvasContainer2c.sketchInstance = p5Instance2c;
    
    // Set up an Intersection Observer to manage noLoop/loop
    let observer2c = new IntersectionObserver((entries) => {
      ...
      // Start observing
    observer2c.observe(canvasContainer2c);
